namespace TApp
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            uiTableLayoutPanel6.RowStyles.Add(new RowStyle(SizeType.Percent, 46.4646454F));
            uiTableLayoutPanel6.RowStyles.Add(new RowStyle(SizeType.Percent, 53.5353546F));
            ...
            btnClose.Location = new Point(3, 51);
            btnClose.MinimumSize = new Size(1, 1);
            btnClose.Name = "btnClose";
            btnClose.Radius = 4;
            btnClose.RectColor = Color.Red;
            btnClose.Size = new Size(185, 51);
